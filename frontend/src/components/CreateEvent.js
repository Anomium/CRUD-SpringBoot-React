                        ...
                        <div>
                            <div className="card card-body">
                                ...
                                <form onSubmit={this.onSubmit}>
                                    <label htmlFor="staticEmail" className="col-form-label">Contenido</label>
                                    <div className="form-group">
                                        <input className="form-control" name='content' type="text" onChange={this.onChangeInput} />
                                    </div>

                                    <label htmlFor="staticEmail" className="col-form-label">Autor</label>
                                    <div className="form-group">
                                        <input className="form-control" name='author' type="text" onChange={this.onChangeInput} />
                                    </div>

                                    <label htmlFor="staticEmail" className="col-form-label">Fecha</label>
                                    <div className="form-group">
